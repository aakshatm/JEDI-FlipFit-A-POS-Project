...
public class PaymentService implements PaymentInterface {
     ...
     *
     * @param payments the Payment object containing payment details to be validated
     * @return true if the card details are valid and OTP is verified; false otherwise
     */
    @Override
    public boolean validateCardDetails(Payment payments) {
     ...
     *
     * @param payments the Payment object (not used in current implementation but included for method signature)
     * @return the generated OTP
     */
    @Override
    public int requestOTP(Payment payments) {
